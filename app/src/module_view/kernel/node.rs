...
pub(in crate::module_view) struct Items {
...
impl Items {
    ...
    pub(in crate::module_view) async fn send(&mut self, result: Answer) -> bool {
        self.replies
    ...
    pub(in crate::module_view) fn end(self, result: Answer) {
...
pub(in crate::module_view) fn spawn_subscription<Body, Fut>(guest: &mut Guest, id: u64, body: Body)
where
...
pub(in crate::module_view) fn spawn_device(
    guest: &mut Guest,
    id: u64,
...
pub(in crate::module_view) struct NodeTask {
